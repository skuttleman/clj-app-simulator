(ns com.ben-allred.clj-app-simulator.templates.simulators.file.resources
  (:require [clojure.string :as string]
            [com.ben-allred.clj-app-simulator.templates.simulators.shared.resources :as shared.resources]
...
(defn edit-config []
  {:delay    [(f/pred #(and (not (nums/nan? %)) (number? %)) "Delay must be a number")
