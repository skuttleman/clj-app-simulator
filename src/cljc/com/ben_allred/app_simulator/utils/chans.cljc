(ns com.ben-allred.app-simulator.utils.chans
...
(defmacro ->then [ch binding & body]
  `(com.ben-allred.app-simulator.utils.chans/then ~ch (fn [~binding] ~@body)))

(defmacro ->peek [ch binding & body]
  `(com.ben-allred.app-simulator.utils.chans/peek ~ch (fn [~binding] ~@body)))

(defmacro ->finally [ch & body]
  `(com.ben-allred.app-simulator.utils.chans/finally ~ch (fn [] ~@body)))
