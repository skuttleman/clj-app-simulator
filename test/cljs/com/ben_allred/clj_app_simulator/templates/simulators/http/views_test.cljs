(ns com.ben-allred.clj-app-simulator.templates.simulators.http.views-test
  (:require [clojure.test :as t :refer [deftest testing is] :include-macros true]
            ...
            [com.ben-allred.clj-app-simulator.templates.simulators.http.resources :as resources]
    ...
    (let [update-spy (spies/create)
      ...
      (with-redefs [forms/update-in update-spy
        ...
        (let [root (http.views/headers-field ::form)
              multi (test.dom/query-one root ff/multi)
              attrs (test.dom/attrs multi)]
          (testing "renders multi field"
            (is (= ff/header (last multi))))
    ...
    (let [form-spy (spies/constantly ::form)]
      (with-redefs [forms/create form-spy]
        (testing "renders the form"
          (let [component (http.views/sim-create-form nil)]
